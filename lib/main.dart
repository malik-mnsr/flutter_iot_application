...
Future<void> main() async {
  ...
  // AJOUT OPPORTUNEL pour initialiser l'historique
  try {
    await HistoryService().initialize();
    debugPrint('✅ HistoryService initialized');
  } catch (e) {
    debugPrint('⚠️ HistoryService not initialized: $e');
  }
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        appBarTheme: const AppBarTheme(
          centerTitle: true,
          elevation: 0,
          backgroundColor: Color(COLOR_PRIMARY), // AJOUT OPPORTUNEL
          foregroundColor: Colors.white, // AJOUT OPPORTUNEL
        ),
        // AJOUT OPPORTUNEL pour améliorer les boutons
